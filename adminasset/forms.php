            ...
            <form action="forms.php" method="POST" class="form">
                ...
                <div class="column">
                    <div class="input-box">
                        ...
                        <input type="number" placeholder="ادخل رقم الهاتف  " name="phone" required>
                    </div>

                    <div class="input-box">
                        <label>كم سنه لك في هذا المجال</label>
                        <input type="number" placeholder="من فضلك جاوب" name="year_field" required>
                    </div>
                    <div class="input-box">
                        <label> تاريخ ميلادك</label>
                        <input type="datetime-local" placeholder="اذا متحب تكول ف مو ضروري">
                    </div>
                </div>
                ...
                <div class="column-sub">
                    <button type="submit" class="submit" name="set">ارسال</button>
                    <button type="reset" class="reset" name="reset">مسح البيانات</button>
                </div>
        </fieldset>
        </form>
    </section>
